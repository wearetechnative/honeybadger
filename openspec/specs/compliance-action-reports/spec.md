...
## Purpose
Write a companion actions report alongside the compliance checklist: every finding grouped by severity, with its details, a remediation timeline, summary statistics and a link back to the compliance report, rendered as markdown and stable in ordering.
