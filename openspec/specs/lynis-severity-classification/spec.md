# Lynis Severity Classification

## Purpose
Assign a market-standard severity to each Lynis finding by case-insensitive keyword matching, and extract the detail fields the compliance and action reports need, so findings can be grouped and prioritised consistently.
