# fastfetch-system-info Specification

## Purpose
This specification defines how honeybadger collects system information using fastfetch during an audit, including the shipped configuration, JSON output format, compliance fields, and dependency requirements.
