...
## Purpose
Run the NixOS supply chain audit on NixOS hosts, parse its result into a pass/fail status with failure reasons and store-integrity detail, and persist the raw output alongside the other audit artifacts.
